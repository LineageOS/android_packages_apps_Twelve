...
class SubsonicClient(
    ...
    private val serverUri = server.toUri().buildUpon().apply { appendPath("rest") }.build()
     ...
     */
    suspend fun ping() =
        ApiRequest.get<ResponseRoot>(listOf("ping")).execute(api).mapResponse { this }
    ...
    suspend fun getLicense() =
        ApiRequest.get<ResponseRoot>(listOf("getLicense"))
            .execute(api)
    ...
    suspend fun getMusicFolders() =
        ApiRequest.get<ResponseRoot>(listOf("getMusicFolders"))
            .execute(api)
     ...
     * @since 1.0.0
     */
    suspend fun getIndexes(musicFolderId: Int? = null, ifModifiedSince: Long? = null) =
        ApiRequest.get<ResponseRoot>(
                listOf("getIndexes"),
                queryParameters =
                    listOf("musicFolderId" to musicFolderId, "ifModifiedSince" to ifModifiedSince),
            )
            .execute(api)
    ...
    suspend fun getMusicDirectory(id: String) =
        ApiRequest.get<ResponseRoot>(
                ...
                queryParameters = listOf("id" to id),
            )
            .execute(api)
    ...
    suspend fun getGenres() =
        ApiRequest.get<ResponseRoot>(listOf("getGenres"))
            .execute(api)
    ...
    suspend fun getArtists(musicFolderId: Int? = null) =
        ApiRequest.get<ResponseRoot>(
                listOf("getArtists"),
                queryParameters = listOf("musicFolderId" to musicFolderId),
            )
            .execute(api)
    ...
    suspend fun getArtist(id: String) =
        ApiRequest.get<ResponseRoot>(listOf("getArtist"), queryParameters = listOf("id" to id))
            .execute(api)
    ...
    suspend fun getAlbum(id: String) =
        ApiRequest.get<ResponseRoot>(listOf("getAlbum"), queryParameters = listOf("id" to id))
            .execute(api)
    ...
    suspend fun getSong(id: String) =
        ApiRequest.get<ResponseRoot>(listOf("getSong"), queryParameters = listOf("id" to id))
            .execute(api)
    ...
    suspend fun getVideos() =
        ApiRequest.get<ResponseRoot>(listOf("getVideos"))
            .execute(api)
    ...
    suspend fun getVideoInfo(id: String) =
        ApiRequest.get<ResponseRoot>(listOf("getVideoInfo"), queryParameters = listOf("id" to id))
            .execute(api)
    ...
    suspend fun getArtistInfo(id: String, count: Int? = null, includeNotPresent: Boolean? = null) =
        ApiRequest.get<ResponseRoot>(
                ...
                queryParameters =
                    listOf("id" to id, "count" to count, "includeNotPresent" to includeNotPresent),
            )
            .execute(api)
    ...
    suspend fun getAlbumInfo(id: String) =
        ApiRequest.get<ResponseRoot>(listOf("getAlbumInfo"), queryParameters = listOf("id" to id))
            .execute(api)
    ...
    suspend fun getAlbumInfo2(id: String) =
        ApiRequest.get<ResponseRoot>(listOf("getAlbumInfo2"), queryParameters = listOf("id" to id))
            .execute(api)
            .mapResponse(SubsonicResponse::albumInfo)
    ...
    suspend fun getSimilarSongs(id: String, count: Int? = null) =
        ApiRequest.get<ResponseRoot>(
                ...
                queryParameters = listOf("id" to id, "count" to count),
            )
            .execute(api)
    ...
    suspend fun getTopSongs(artist: String, count: Int? = null) =
        ApiRequest.get<ResponseRoot>(
                listOf("getTopSongs"),
                queryParameters = listOf("artist" to artist, "count" to count),
            )
            .execute(api)
    ...
    suspend fun getNowPlaying() =
        ApiRequest.get<ResponseRoot>(listOf("getNowPlaying"))
            .execute(api)
     ...
     * @param newerThan Only return matches that are newer than this. Given as milliseconds
     *   since 1970.
     * @since 1.0.0
     */
    ...
    /**
     * Returns albums, artists and songs matching the given search criteria. Supports paging through
     * the result.
     *
    ...
    suspend fun getPlaylists(username: String? = null) =
        ApiRequest.get<ResponseRoot>(
                listOf("getPlaylists"),
                queryParameters = listOf("username" to username),
            )
            .execute(api)
    ...
    suspend fun getPlaylist(id: String) =
        ApiRequest.get<ResponseRoot>(listOf("getPlaylist"), queryParameters = listOf("id" to id))
            .execute(api)
    ...
    suspend fun deletePlaylist(id: String) =
        ApiRequest.get<ResponseRoot>(listOf("deletePlaylist"), queryParameters = listOf("id" to id))
            .execute(api)
            .mapResponse {}
    ...
    fun download(id: String) =
        api.buildUrl(
            listOf("download"),
            queryParameters = listOf("id" to id) + interceptor.getAuthParameters(),
        )
     ...
     * @since 1.8.0
     */
    fun hls(id: String, bitRate: String? = null, audioTrack: Int? = null) =
        api.buildUrl(
            listOf("hls"),
            queryParameters =
                listOf("id" to id, "bitRate" to bitRate, "audioTrack" to audioTrack) +
                    interceptor.getAuthParameters(),
        )
     ...
     * @since 1.14.0
     */
    fun getCaptions(id: String, format: String? = null) =
        api.buildUrl(
            listOf("getCaptions"),
            queryParameters =
                listOf("id" to id, "format" to format) + interceptor.getAuthParameters(),
        )
     ...
     * @since 1.0.0
     */
    fun getCoverArt(id: String, size: Int? = null) =
        api.buildUrl(
            listOf("getCoverArt"),
            queryParameters = listOf("id" to id, "size" to size) + interceptor.getAuthParameters(),
        )
     ...
     * @since 1.2.0
     */
    fun getLyrics(artist: String? = null, title: String? = null) =
        api.buildUrl(
            listOf("getLyrics"),
            queryParameters =
                listOf("artist" to artist, "title" to title) + interceptor.getAuthParameters(),
        )
    ...
    fun getAvatar(username: String) =
        api.buildUrl(
            listOf("getAvatar"),
            queryParameters = listOf("username" to username) + interceptor.getAuthParameters(),
        )
    ...
    suspend fun setRating(id: String, rating: Int) =
        ApiRequest.get<ResponseRoot>(
                listOf("setRating"),
                queryParameters = listOf("id" to id, "rating" to rating),
            )
            .execute(api)
            .mapResponse {}
     ...
     * on the Subsonic server (Settings > Personal). Updates the play count and last played
     * timestamp for the media files. (Since 1.11.0) Makes the media files appear in the "Now
     * playing" page in the web app, and appear in the list of songs returned by [getNowPlaying]
     * (Since 1.11.0) Since 1.8.0 you may specify multiple id (and optionally time) parameters to
     ...
     * @since 1.5.0
     */
    suspend fun scrobble(ids: List<String>, time: Long? = null, submission: Boolean? = null) =
        ApiRequest.get<ResponseRoot>(
                listOf("scrobble"),
                queryParameters =
                    listOf(
    ...
    suspend fun getShares() =
        ApiRequest.get<ResponseRoot>(listOf("getShares"))
            .execute(api)
     ...
     * @since 1.6.0
     */
    suspend fun createShare(id: String, description: String? = null, expires: Long? = null) =
        ApiRequest.get<ResponseRoot>(
                listOf("createShare"),
                queryParameters =
                    listOf("id" to id, "description" to description, "expires" to expires),
            )
            .execute(api)
            .mapResponse(SubsonicResponse::shares)
     ...
     * @since 1.6.0
     */
    suspend fun updateShare(id: String, description: String? = null, expires: Long? = null) =
        ApiRequest.get<ResponseRoot>(
                listOf("updateShare"),
                queryParameters =
                    listOf("id" to id, "description" to description, "expires" to expires),
    ...
    suspend fun deleteShare(id: String) =
        ApiRequest.get<ResponseRoot>(listOf("deleteShare"), queryParameters = listOf("id" to id))
            .execute(api)
            .mapResponse {}

    /**
     * Returns all Podcast channels the server subscribes to, and (optionally) their episodes. This
     * method can also be used to return details for only one channel - refer to the id parameter. A
     * typical use case for this method would be to first retrieve all channels without episodes,
     ...
     * @since 1.6.0
     */
    suspend fun getPodcasts(includeEpisodes: Boolean? = null, id: String? = null) =
        ApiRequest.get<ResponseRoot>(
                listOf("getPodcasts"),
                queryParameters = listOf("includeEpisodes" to includeEpisodes, "id" to id),
            )
            .execute(api)
     ...
     * @since 1.13.0
     */
    suspend fun getNewestPodcasts(count: Int? = null) =
        ApiRequest.get<ResponseRoot>(
                listOf("getNewestPodcasts"),
                queryParameters = listOf("count" to count),
            )
            .execute(api)
    ...
    suspend fun refreshPodcasts() =
        ApiRequest.get<ResponseRoot>(listOf("refreshPodcasts")).execute(api).mapResponse {}
     ...
     * @since 1.9.0
     */
    suspend fun createPodcastChannel(url: String) =
        ApiRequest.get<ResponseRoot>(
                listOf("createPodcastChannel"),
                queryParameters = listOf("url" to url),
            )
            .execute(api)
            .mapResponse {}
     ...
     * @since 1.9.0
     */
    suspend fun deletePodcastChannel(id: String) =
        ApiRequest.get<ResponseRoot>(
     ...
     * @since 1.9.0
     */
    suspend fun deletePodcastEpisode(id: String) =
        ApiRequest.get<ResponseRoot>(
     ...
     * @since 1.9.0
     */
    suspend fun downloadPodcastEpisode(id: String) =
        ApiRequest.get<ResponseRoot>(
     ...
     * @param ids Used by `add` and `set`. ID of song to add to the jukebox playlist. Use multiple
     *   id parameters to add many songs in the same request. (set is similar to a clear followed by
     *   a add, but will not change the currently playing track.)
    ...
    suspend fun getInternetRadioStations() =
        ApiRequest.get<ResponseRoot>(listOf("getInternetRadioStations"))
            .execute(api)
     ...
     */
    suspend fun getLyricsBySongId(id: String) =
        ApiRequest.get<ResponseRoot>(
                listOf("getLyricsBySongId"),
                queryParameters = listOf("id" to id),
            )
            .execute(api)
            .mapResponse(SubsonicResponse::lyricsList)

    // TODO

    private fun SubsonicError.Code.toError() =
        when (this) {
            ...
            SubsonicError.Code.MULTIPLE_CONFLICTING_AUTHENTICATION_MECHANISMS ->
        ...
        when (this) {
            is Result.Success -> {
                when (data.subsonicResponse.status) {
                    ResponseStatus.OK ->
                        runCatching { data.subsonicResponse.methodValue()!! }
                            .fold(
