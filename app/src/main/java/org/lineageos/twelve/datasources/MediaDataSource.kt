...
interface MediaDataSource {
     ...
     * @return [Result.Success] with a list of [DataSourceInformation] if everything is fine, else
     *   [Result.Error]
     */
    fun status(
    ...
    /**
     * Given a compatible media item URI, get the [ProviderIdentifier] of the provider that handles
     * this media item.
     *
     * @param mediaItemUri The media item to check
    ...
    /**
     * Start a search for the given query. Only the following items can be returned: [Album],
     * [Artist], [Audio], [Genre], [Playlist].
     *
     * @param providerIdentifier The [ProviderIdentifier] of the provider
