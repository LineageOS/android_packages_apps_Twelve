...
data class PublisherMetadata(
    ...
    @SerialName("contains_music") val containsMusic: Boolean,
    @SerialName("upc_or_ean") val upcOrEan: String,
    val isrc: String,
    val explicit: Boolean,
    @SerialName("p_line") val pLine: String,
    @SerialName("p_line_for_display") val pLineForDisplay: String,
