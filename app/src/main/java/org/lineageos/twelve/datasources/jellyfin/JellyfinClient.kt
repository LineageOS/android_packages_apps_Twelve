...
class JellyfinClient(
    ...
    suspend fun renamePlaylist(id: UUID, name: String) = postMethodNoResponse<UpdatePlaylistDto>(
        listOf(
            "Playlists",
            id.toString(),
        ),
    ...
    suspend fun addItemToPlaylist(id: UUID, audioId: UUID) = postMethodNoResponse<Any>(
        listOf(
            "Playlists",
            id.toString(),
            "Items",
    ...
    private suspend inline fun <reified T> postMethodNoResponse(
        method: List<String>,
        queryParameters: List<Pair<String, Any?>> = emptyList(),
        bodyParameter: T? = null,
    ) = okHttpClient.newCall(
