...
class ListItem @JvmOverloads constructor(
     ...
     */
    enum class State(
        val isViewEnabled: Boolean = true,
        val areChildrenEnabled: Boolean = isViewEnabled,
        ...
        /**
         * Disabled state, equivalent to [isEnabled] equal to false.
         */
        DISABLED(isViewEnabled = false),

        /**
         * View is still enabled, but with a greyed out appearance.
         */
        DIMMED(areChildrenEnabled = false),
    ...
    fun setState(state: State) {
        super.setEnabled(state.isViewEnabled)

        setViewsProperty(View::setEnabled, state.areChildrenEnabled)
