...
constructor(
    ...
    private val popupMenu =
        PopupMenu(context, this).apply {
            ...
            setOnMenuItemClickListener {
                ...
                val reverse =
                    sortingRule
                        ?.takeIf { sortingRule -> sortingRule.strategy == strategy }
                        ?.reverse
                        ?.not() ?: sortingRule?.reverse ?: false
    ...
    init {
        ...
        setOnClickListener { openPopupMenu() }
    }
    ...
    fun setSortingStrategies(sortingStrategies: SortedMap<SortingStrategy, Int>) {
        ...
        sortingStrategies.forEach { (sortingStrategy, stringResId) ->
            popupMenu.menu.add(0, sortingStrategy.ordinal, 0, stringResId)
    ...
    fun setSortingRule(sortingRule: SortingRule) {
        ...
        setText(sortingStrategies[sortingRule.strategy] ?: R.string.sort_by_unknown)
