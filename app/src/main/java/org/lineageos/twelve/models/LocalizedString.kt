...
sealed interface LocalizedString {
    ...
    class StringLocalizedString(private val value: String) : LocalizedString {
        override fun getString(resources: Resources) = value

        override fun areContentsTheSame(other: LocalizedString) =
            areContentsTheSame(other) { this.value == it.value }
    }
    ...
    class StringResIdLocalizedString(
        ...
        override fun getString(resources: Resources) =
        ...
        override fun areContentsTheSame(other: LocalizedString) =
            areContentsTheSame(other) {
                this.stringResId == it.stringResId &&
                    this.stringResIdArgs
                        ?.toTypedArray()
                        .contentEquals(it.stringResIdArgs?.toTypedArray())
            }
    }
