...
object AudioQualityClassifier {
    ...
    fun classify(
        ...
        val audioDeviceConfiguration = outputAudioFormat?.let {
            OutputConfiguration.AudioDeviceConfiguration(
                type = OutputConfiguration.AudioDeviceConfiguration.Type.INTERNAL,
                sampleRate = it.sampleRate,
                channelCount = it.channelCount,
            )
        } ?: return null
