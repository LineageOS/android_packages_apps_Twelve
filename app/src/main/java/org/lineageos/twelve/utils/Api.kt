...
sealed interface MethodResult<T> {
    ...
    sealed class Error<T>(open val error: Throwable? = null) : MethodResult<T>
    data class HttpError<T>(val code: Int, override val error: Throwable? = null) : Error<T>(error)
    data class GenericError<T>(override val error: Throwable? = null) : Error<T>(error)
    data class DeserializationError<T>(override val error: Throwable? = null) : Error<T>(error)
    data class CancellationError<T>(override val error: Throwable? = null) : Error<T>(error)
}
