...
import org.lineageos.twelve.ext.onDestinationChangedFlow
...
class MainActivity : AppCompatActivity(R.layout.activity_main) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(frameLayout) { _, windowInsets ->
            ...
            nowPlayingBar.updateLayoutParams<MarginLayoutParams> {
    ...
    private fun CoroutineScope.loadData() {
        ...
        launch {
            combine(
                ...
                navController.onDestinationChangedFlow(),
            ) { mediaItem, (_, destination, _) ->
                mediaItem != null && run {
                    var id = destination.id
                    while (id in dialogDestinationsIds) {
                        id = destination.parent?.id ?: return@run false
                    }

                    id !in nowPlayingRelatedRouteIds
                }
            }
    ...
    companion object {
        ...
        /**
         * Dialog destinations IDs.
         */
        private val dialogDestinationsIds = setOf(
            R.id.createPlaylistDialogFragment,
            R.id.nowPlayingStatsBottomSheetDialogFragment,
            R.id.playbackControlBottomSheetDialogFragment,
            R.id.providerSelectorDialogFragment,
        )
