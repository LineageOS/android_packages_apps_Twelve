...
private val DEFAULT_PROVIDER_DEFAULT_VALUE = ProviderIdentifier.DEFAULT
var SharedPreferences.defaultProvider: ProviderIdentifier
    get() = when (val json = getString(DEFAULT_PROVIDER_KEY, null)) {
        null -> DEFAULT_PROVIDER_DEFAULT_VALUE
