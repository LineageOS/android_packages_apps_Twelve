...
var SharedPreferences.enableOffload: Boolean
    ...
    set(value) = edit { putBoolean(ENABLE_OFFLOAD_KEY, value) }
...
var SharedPreferences.enableFloatOutput: Boolean
    ...
    set(value) = edit { putBoolean(ENABLE_FLOAT_OUTPUT_KEY, value) }
...
var SharedPreferences.stopPlaybackOnTaskRemoved: Boolean
    ...
    set(value) = edit { putBoolean(STOP_PLAYBACK_ON_TASK_REMOVED_KEY, value) }
...
var SharedPreferences.defaultProvider: ProviderIdentifier?
    get() =
        getString(DEFAULT_PROVIDER_KEY, null)?.let {
            runCatching { Json.decodeFromString(serializer<ProviderIdentifier>(), it) }.getOrNull()
        }
    set(value) = edit {
        putString(
...
var SharedPreferences.typedRepeatMode: RepeatMode
    ...
    set(value) = edit { putInt(TYPED_REPEAT_MODE_KEY, value.ordinal) }
...
var SharedPreferences.shuffleModeEnabled: Boolean
    ...
    set(value) = edit { putBoolean(SHUFFLE_MODE_ENABLED_KEY, value) }
...
private fun SharedPreferences.getSortingRule(
    ...
    SortingRule(
        getString(strategyKey, defaultSortingRule.strategy.name).let { strategy ->
            SortingStrategy.entries.firstOrNull { it.name == strategy }
...
var SharedPreferences.albumsSortingRule: SortingRule
    ...
    set(value) = setSortingRule(ALBUMS_SORTING_STRATEGY_KEY, ALBUMS_SORTING_REVERSE_KEY, value)
...
var SharedPreferences.artistsSortingRule: SortingRule
    ...
    set(value) = setSortingRule(ARTISTS_SORTING_STRATEGY_KEY, ARTISTS_SORTING_REVERSE_KEY, value)
...
var SharedPreferences.genresSortingRule: SortingRule
    ...
    set(value) = setSortingRule(GENRES_SORTING_STRATEGY_KEY, GENRES_SORTING_REVERSE_KEY, value)
...
var SharedPreferences.playlistsSortingRule: SortingRule
    ...
    set(value) =
        setSortingRule(PLAYLISTS_SORTING_STRATEGY_KEY, PLAYLISTS_SORTING_REVERSE_KEY, value)
