        ...
        navigationBarView.setOnItemSelectedListener { item ->
            when (item.itemId) {
                R.id.activityFragment -> {
                    findNavController().navigateSafe(R.id.action_mainFragment_to_fragment_activity)
                    true
                }
                ...
                R.id.libraryFragment -> {
                    findNavController().navigateSafe(R.id.action_mainFragment_to_fragment_library)
                    true
                }
